...
Source0  : https://download.gnome.org/sources/NetworkManager-openvpn/1.8/NetworkManager-openvpn-1.8.14.tar.xz
...
%prep
%setup -q -n NetworkManager-openvpn-1.8.14
cd %{_builddir}/NetworkManager-openvpn-1.8.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622828325
...
cp %{_builddir}/NetworkManager-openvpn-1.8.14/COPYING %{buildroot}/usr/share/package-licenses/NetworkManager-openvpn/7231584ac45906565081b89c0ca8d5fe7f738eb0
%make_install
