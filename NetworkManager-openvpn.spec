...
Version  : 1.11.0
Release  : 18
URL      : https://download.gnome.org/sources/NetworkManager-openvpn/1.11/NetworkManager-openvpn-1.11.0.tar.xz
Source0  : https://download.gnome.org/sources/NetworkManager-openvpn/1.11/NetworkManager-openvpn-1.11.0.tar.xz
...
%prep
%setup -q -n NetworkManager-openvpn-1.11.0
cd %{_builddir}/NetworkManager-openvpn-1.11.0
pushd ..
cp -a NetworkManager-openvpn-1.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715005660
