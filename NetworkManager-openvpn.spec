...
Version  : 1.8.18
Release  : 10
URL      : https://download.gnome.org/sources/NetworkManager-openvpn/1.8/NetworkManager-openvpn-1.8.18.tar.xz
Source0  : https://download.gnome.org/sources/NetworkManager-openvpn/1.8/NetworkManager-openvpn-1.8.18.tar.xz
...
%prep
%setup -q -n NetworkManager-openvpn-1.8.18
cd %{_builddir}/NetworkManager-openvpn-1.8.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647884521
...
cp %{_builddir}/NetworkManager-openvpn-1.8.18/COPYING %{buildroot}/usr/share/package-licenses/NetworkManager-openvpn/7231584ac45906565081b89c0ca8d5fe7f738eb0
%make_install
