...
Version  : 1.10.2
Release  : 17
URL      : https://download.gnome.org/sources/NetworkManager-openvpn/1.10/NetworkManager-openvpn-1.10.2.tar.xz
Source0  : https://download.gnome.org/sources/NetworkManager-openvpn/1.10/NetworkManager-openvpn-1.10.2.tar.xz
...
%prep
%setup -q -n NetworkManager-openvpn-1.10.2
cd %{_builddir}/NetworkManager-openvpn-1.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680040782
